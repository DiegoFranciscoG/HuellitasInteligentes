# Sentencias SQL para DBeaver (Solución a Reacciones y Denuncias)

Ejecuta el siguiente script en tu base de datos (PostgreSQL) usando DBeaver para actualizar las funciones y solucionar el problema de las reacciones en la comunidad y las denuncias que no llegan al administrador.
